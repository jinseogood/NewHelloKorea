...
<body>
	...
	<div id="userJoinDiv" class="modal fade" role="dialog" style="height:420px;">
		...
		<div id="loginModal" class="col-md-3">
			<div id="inModal" class="login-box well" style="height:230px;">
				<form action="insertUser.me" method="post" id="userForm">
					...
					<div class="form-group">
						<input type="button" onclick="emailCheck()" class="btn btn-default btn-login-submit btn-block m-t-md" value="회원가입" />
					</div>
				</form>
			</div>
