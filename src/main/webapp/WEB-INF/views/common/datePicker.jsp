...
$(function() {
      ...
      $('#fromDate').datepicker({
         ...
         buttonImage : "${contextPath}/resources/img/date.png", // 버튼 이미지
      ...
      $('#toDate').datepicker({
         showOn : "both",
         buttonImage : "${contextPath}/resources/img/date.png",
...
<body>
   <!-- <font id="web-fontDate">오늘 날짜 : <span id="today"></span></font>
   <br> -->
   <!-- <label for="fromDate" id="web-fontDate">시작일</label> -->
   <input type="text" name="fromDate" id="fromDate" class="web-font">
   &nbsp;&nbsp;<font class="web-font">~</font>&nbsp;&nbsp;
