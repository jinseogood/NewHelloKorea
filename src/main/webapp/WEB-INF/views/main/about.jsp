			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="${ contextPath }/resources/img/about-4.jpg" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="${ contextPath }/resources/img/about-5.jpg" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="${ contextPath }/resources/img/about-6.jpg" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><img src="${ contextPath }/resources/img/about-7.jpg" alt="img" class="tm-about-box-1-img"></a>
				...
				<div class="col-lg-12">
					<div class="tm-what-we-do-right">
						<div class="tm-about-box-2 margin-bottom-30">
							<img src="${ contextPath }/resources/img/about-2.jpg" alt="image" class="tm-about-box-2-img">
						...
						<div class="tm-about-box-2">
							<img src="${ contextPath }/resources/img/about-3.jpg" alt="image" class="tm-about-box-2-img">
							<div class="tm-about-box-2-text">
